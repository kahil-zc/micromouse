// Runs the maze section of 22_micromouse_final.ino on random 5 x 10 mazes.
//   tests/micromouse_22_sim.sh
// The script copies the lines between "// --- MAZE (no hardware calls) ---" and
// "// --- END MAZE ---" into maze_22_section.inc, so this tests the exact planner the robot runs.
//
